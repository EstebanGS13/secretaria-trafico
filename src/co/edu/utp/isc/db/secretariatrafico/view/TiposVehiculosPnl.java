 ...
 * @author Esteban
 */
public class TiposVehiculosPnl extends javax.swing.JPanel implements Crud {

    /**
     * Creates new form TiposVehiculosPnl
     */
    public TiposVehiculosPnl() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipos Vehículos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14))); // NOI18N
        setPreferredSize(new java.awt.Dimension(1024, 210));

        jLabel1.setText("ID tipo vehículo:");
    ...
    private TiposVehiculos tipoVehiculo = new TiposVehiculos();
    ...
    public void cargarRegistros() {
        try {
            ...
            for (TiposVehiculos t : listaTiposVehiculos) {
                modelo.addRow(new Object[]{
                    t.getIdTipoVehiculo(),
                    t.getNombreTipoVehiculo()
                });
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    public void registrar() {
        tipoVehiculo.setNombreTipoVehiculo(txtNombre.getText().trim());
    }
    ...
    public void guardar() {
        try {
            if (txtId.getText().isEmpty()) {
                ...
                tipoVehiculo.setIdTipoVehiculo(Integer.parseInt(txtId.getText().trim()));
            }
            
            registrar();
            
            JpaController.getInstance().getTiposVehiculosControlador().create(tipoVehiculo);
    ...
    public void actualizar() {
        try {
            ...
            JpaController.getInstance().getTiposVehiculosControlador().edit(tipoVehiculo);
    ...
    public void eliminar(JTable tblTabla) {
        ...
        try {
            JpaController.getInstance().getTiposVehiculosControlador().destroy(id);
