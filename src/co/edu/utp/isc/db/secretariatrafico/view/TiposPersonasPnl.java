 ...
 * @author Esteban
 */
public class TiposPersonasPnl extends javax.swing.JPanel implements Crud {

    /**
     * Creates new form TiposPersonasPnl
     */
    public TiposPersonasPnl() {
        initComponents();
    }
    ...
    private TiposPersonas tipoPersona = new TiposPersonas();
    ...
    public void cargarRegistros() {
        try {
            ...
            for (TiposPersonas t : listaTiposPersonas) {
                modelo.addRow(new Object[]{
                    t.getIdTipoPersona(),
                    t.getNombreTipoPersona()
                });
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    public void registrar() {
        tipoPersona.setNombreTipoPersona(txtNombre.getText().trim());
    }
    ...
    public void guardar() {
        try {
            if (txtId.getText().isEmpty()) {
                tipoPersona.setIdTipoPersona(null);
            } else {
                tipoPersona.setIdTipoPersona(Integer.parseInt(txtId.getText().trim()));
            }
            
            registrar();
            
            JpaController.getInstance().getTiposPersonasControlador().create(tipoPersona);
    ...
    public void actualizar() {
        try {
            ...
            JpaController.getInstance().getTiposPersonasControlador().edit(tipoPersona);
    ...
    public void eliminar(JTable tblTabla) {
        ...
        try {
            JpaController.getInstance().getTiposPersonasControlador().destroy(id);
